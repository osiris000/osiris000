...
if(!$_REQUEST["file"]) {
	...
	die("Error no existe ruta al archivo: $fconf");
...
AUTOCONF = true
AUTOCONF_TIME = {$time}
AUTOCONF_INFO = Osiris php parse ini
_SYS_DEBUG = 1
_SYS_VARS = 1
#continue
CNF;
...
if(is_resource($_ASX_value)){
   ...
   // no se puede hacer eval en este caso
   // para ejecutar php, guardar fuente temporal
   // y hacer include, require, shell_exec o popen
